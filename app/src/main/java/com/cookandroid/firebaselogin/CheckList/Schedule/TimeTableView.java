...
import com.cookandroid.firebaselogin.CheckList.Schedule.Highlight;
import com.cookandroid.firebaselogin.CheckList.Schedule.Time;
...
public class TimeTableView extends LinearLayout {
    ...
    private static final int DEFAULT_STICKER_FONT_DP = 13;
    ...
    private Highlight highlight = Highlight.COLOR;
    ...
    private void getAttrs(AttributeSet attrs){
        ...
        if(highlightTypeValue == 0) highlight = Highlight.COLOR;
        else if(highlightTypeValue == 0) highlight = Highlight.IMAGE;
    ...
    public ArrayList<Schedule> getAllScheduleInStickers() {
    ...
    public void remove(int idx) {
        com.cookandroid.firebaselogin.CheckList.Schedule.Sticker sticker = stickers.get(idx);
        for (TextView tv : sticker.getView()) {
            stickerBox.removeView(tv);
        }
        stickers.remove(idx);
    ...
    public void setHeaderHighlight(int idx) {
        ...
        else if(highlight == Highlight.IMAGE){
    ...
    private void onCreateByBuilder(TimeTableView.Builder builder) {
    ...
    static class Builder {
        ...
        public TimeTableView.Builder setColumnCount(int n) {
            this.columnCount = n;
            return this;
        }

        public TimeTableView.Builder setCellHeight(int dp) {
            this.cellHeight = dp2Px(dp);
            return this;
        }

        public TimeTableView.Builder setSideCellWidth(int dp) {
            this.sideCellWidth = dp2Px(dp);
            return this;
        }

        public TimeTableView.Builder setHeaderTitle(String[] titles) {
            this.headerTitle = titles;
            return this;
        }

        public TimeTableView.Builder setStickerColors(String[] colors) {
            this.stickerColors = colors;
            return this;
        }

        public TimeTableView.Builder setStartTime(int t) {
            this.startTime = t;
            return this;
        }

        public TimeTableView.Builder setHeaderHighlightColor(int c) {
